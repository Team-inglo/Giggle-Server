...
//        private final String hwpUrl;
        ...
        public static DocumentDetailDto from(Document document, EEmployeeStatus status) {
    ...
    public static class SimpleDocumentDto {
        ...
        public static SimpleDocumentDto from(Document document) {
    ...
    public static ReadUserDocumentSummaryResponseDto of(
        ...
        return ReadUserDocumentSummaryResponseDto.builder()
                .partTimeEmploymentPermits(partTimeEmploymentPermits != null ? DocumentDetailDto.from(partTimeEmploymentPermits, partTimeEmploymentPermits.getEmployeeStatus()) : null)
                .standardLaborContract(standardLaborContract != null ? DocumentDetailDto.from(standardLaborContract, standardLaborContract.getEmployeeStatus()) : null)
                .integratedApplication(integratedApplication != null ? SimpleDocumentDto.from(integratedApplication) : null)
