...
public class ReadIntegratedApplicationDetailResponseDto extends SelfValidating<ReadIntegratedApplicationDetailResponseDto> {
    ...
    public static ReadIntegratedApplicationDetailResponseDto from(IntegratedApplication application) {
        return ReadIntegratedApplicationDetailResponseDto.builder()
                ...
                .schoolName(application.getSchoolInfo().getSchoolName())
                .schoolPhoneNumber(application.getSchoolInfo().getSchoolPhoneNumber())
                ...
                .address(AddressResponseDto.from(application.getEmployeeAddress()))
                .build();
    }
}
