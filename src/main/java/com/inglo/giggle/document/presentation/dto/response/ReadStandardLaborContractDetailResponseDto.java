...
public class ReadStandardLaborContractDetailResponseDto extends SelfValidating<ReadStandardLaborContractDetailResponseDto> {
    ...
    public static class EmployeeInformationDto {
        ...
        public static EmployeeInformationDto from(StandardLaborContract standardLaborContract) {
    ...
    public static class EmployerInformationDto {
        ...
        public static EmployerInformationDto from(StandardLaborContract standardLaborContract, List<ContractWorkDayTime> contractWorkDayTimes) {
    ...
    public static ReadStandardLaborContractDetailResponseDto of(
        ...
        return ReadStandardLaborContractDetailResponseDto.builder()
                .employeeInformation(EmployeeInformationDto.from(standardLaborContract))
                .employerInformation(EmployerInformationDto.from(standardLaborContract, contractWorkDayTimes))
                .build();
    }
}
