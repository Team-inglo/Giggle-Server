...
public class ReadPartTimeEmploymentPermitDetailResponseDto extends SelfValidating<ReadPartTimeEmploymentPermitDetailResponseDto> {
    ...
    public static class EmployeeInformationDto {
        ...
        public static EmployeeInformationDto from(PartTimeEmploymentPermit partTimeEmploymentPermit) {
    ...
    public static class EmployerInformationDto {
        ...
        public static EmployerInformationDto from(PartTimeEmploymentPermit partTimeEmploymentPermit) {
    ...
    public static ReadPartTimeEmploymentPermitDetailResponseDto from(PartTimeEmploymentPermit partTimeEmploymentPermit) {
        return ReadPartTimeEmploymentPermitDetailResponseDto.builder()
                .employeeInformation(EmployeeInformationDto.from(partTimeEmploymentPermit))
                .employerInformation(EmployerInformationDto.from(partTimeEmploymentPermit))
                .build();
    }
}
