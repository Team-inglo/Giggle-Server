...
@Getter
public class ReadPartTimeEmploymentPermitDetailResult extends SelfValidating<ReadPartTimeEmploymentPermitDetailResult> {
    ...
    @Builder
    public ReadPartTimeEmploymentPermitDetailResult(
    ...
    public static class EmployeeInformationDto {
        ...
        public static EmployeeInformationDto of(
                String firstName,
                String lastName,
                String major,
    ...
    public static class EmployerInformationDto {
        ...
        public EmployerInformationDto(String companyName, String companyRegistrationNumber, String jobType, String name, String phoneNumber,
                                      ...
                                      String workDaysWeekends, AddressResponseDto address) {
        ...
        public static EmployerInformationDto of(
                String companyName,
            ...
            return EmployerInformationDto.builder()
                    ...
                    .workDaysWeekdays(workDaysWeekdays)
                    .workDaysWeekends(workDaysWeekends)
                    .address(address)
                    .build();
        }
    }
    public static ReadPartTimeEmploymentPermitDetailResult of(EmployeeInformationDto employeeInformation, EmployerInformationDto employerInformation) {
        return ReadPartTimeEmploymentPermitDetailResult.builder()
