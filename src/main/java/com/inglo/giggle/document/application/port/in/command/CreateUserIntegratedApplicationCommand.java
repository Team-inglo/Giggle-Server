...
@Getter
public class CreateUserIntegratedApplicationCommand extends SelfValidating<CreateUserIntegratedApplicationCommand> {
    ...
    public CreateUserIntegratedApplicationCommand(
            UUID accountId,
