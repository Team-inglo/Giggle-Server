...
@Getter
public class CreateUserPartTimeEmploymentPermitCommand extends SelfValidating<CreateUserIntegratedApplicationCommand> {
    ...
    public CreateUserPartTimeEmploymentPermitCommand(
            UUID accountId,
