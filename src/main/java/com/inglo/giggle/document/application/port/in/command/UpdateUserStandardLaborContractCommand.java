...
@Getter
public class UpdateUserStandardLaborContractCommand extends SelfValidating<UpdateUserStandardLaborContractCommand> {
    ...
    public UpdateUserStandardLaborContractCommand(
            UUID accountId,
            Long documentId,
            String firstName,
            String lastName,
