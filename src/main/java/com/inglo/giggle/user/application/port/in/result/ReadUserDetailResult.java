...
@Getter
public class ReadUserDetailResult extends SelfValidating<ReadUserDetailResult> {
    ...
    public static ReadUserDetailResult of(
            String email,
            String profileImgUrl,
            String firstName,
            String lastName,
        ...
        return ReadUserDetailResult.builder()
                .email(email)
