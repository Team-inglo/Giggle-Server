...
@Getter
public class ReadUserSelfDetailResult extends SelfValidating<ReadUserSelfDetailResult> {
    ...
    @Builder
    public ReadUserSelfDetailResult(
            String email,
    ...
    public static ReadUserSelfDetailResult of(
            String email,
            String profileImgUrl,
            String firstName,
            String lastName,
        ...
        return ReadUserSelfDetailResult.builder()
                .email(email)
