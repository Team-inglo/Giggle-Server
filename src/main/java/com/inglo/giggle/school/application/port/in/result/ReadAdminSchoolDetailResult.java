...
@Getter
public class ReadAdminSchoolDetailResult extends SelfValidating<ReadAdminSchoolDetailResult> {
    ...
    @Builder
    public ReadAdminSchoolDetailResult(
            Long id,
            String schoolName,
    ...
    public static ReadAdminSchoolDetailResult of(
            Long id,
            String schoolName,
            String schoolPhoneNumber,
            Boolean isMetropolitan,
        ...
        return ReadAdminSchoolDetailResult.builder()
                .id(id)
