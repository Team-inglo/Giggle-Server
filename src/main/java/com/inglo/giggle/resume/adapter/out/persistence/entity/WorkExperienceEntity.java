...
public class WorkExperienceEntity extends BaseEntity {
    ...
    /* -------------------------------------------- */
    @Builder
    public WorkExperienceEntity(Long id, String experienceTitle, String workplace, LocalDate startDate, LocalDate endDate, String description, ResumeEntity resumeEntity) {
        this.id = id;
