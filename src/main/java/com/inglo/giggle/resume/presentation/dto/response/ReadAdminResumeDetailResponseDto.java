...
public class ReadAdminResumeDetailResponseDto extends SelfValidating<ReadAdminResumeDetailResponseDto> {
    ...
    public static ReadAdminResumeDetailResponseDto of(ResumeAggregateWithUserDto resumeAggregateWithUserDto, List<EducationWithSchoolDto> educationWithSchoolDtos) {
        return ReadAdminResumeDetailResponseDto.builder()
                ...
                .workExperience(!resumeAggregateWithUserDto.resumeAggregate().getWorkExperiences().isEmpty() ? resumeAggregateWithUserDto.resumeAggregate().getWorkExperiences().stream().map(ReadAdminResumeDetailResponseDto.WorkExperienceDto::from).toList() : null)
