...
public class ReadAdminResumeDetailResponseDto extends SelfValidating<ReadAdminResumeDetailResponseDto> {
    ...
    public static ReadAdminResumeDetailResponseDto of(Resume resume, List<WorkExperience> workExperiences, List<Education> educations, LanguageSkill languageSkill, User user) {
        return ReadAdminResumeDetailResponseDto.builder()
                ...
                .personalInformation(ReadAdminResumeDetailResponseDto.PersonalInformationDto.from(user))
                .introduction(resume.getIntroduction())
                .workExperience(!workExperiences.isEmpty() ? workExperiences.stream().map(ReadAdminResumeDetailResponseDto.WorkExperienceDto::from).toList() : null)
                .education(!educations.isEmpty() ? educations.stream().map(ReadAdminResumeDetailResponseDto.EducationDto::from).toList() : null)
                .languages(ReadAdminResumeDetailResponseDto.LanguagesDto.from(languageSkill))
                .build();
    }
}
