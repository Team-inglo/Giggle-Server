...
@Getter
public class ReadOwnerResumeDetailByResumeIdResponseDto extends SelfValidating<ReadOwnerResumeDetailByResumeIdResponseDto> {
    ...
    public static ReadOwnerResumeDetailByResumeIdResponseDto of(Resume resume, List<WorkExperience> workExperiences, List<Education> educations, LanguageSkill languageSkill, User user, WorkPreference workPreference, UUID ownerId) {
        return ReadOwnerResumeDetailByResumeIdResponseDto.builder()
