...
@Getter
public class ReadOwnerResumeDetailResult extends SelfValidating<ReadOwnerResumeDetailResult> {
    ...
    @Builder
    public ReadOwnerResumeDetailResult(
    ...
    public static class PersonalInformationDto {
        ...
        public static PersonalInformationDto of(User user) {
    ...
    public static class LanguagesDto {
        ...
        public static LanguagesDto from(Resume resume) {
            List<LanguageDetailDto> languageDetails = resume.getLanguageSkill().getAdditionalLanguages()
                    .stream()
                    .map(LanguageDetailDto::from)
                    .toList();

            return LanguagesDto.builder()
                    .topik(resume.getLanguageSkill().getTopikLevel())
                    .socialIntegration(resume.getLanguageSkill().getSocialIntegrationLevel())
                    .sejongInstitute(resume.getLanguageSkill().getSejongInstituteLevel())
                    .etc(languageDetails)
                    .build();
        }
    }
    ...
    // TODO: 합칠때 변경
    public static ReadOwnerResumeDetailResult of(UserOwnerJobPostingAggregate userOwnerJobPostingAggregate, Resume resume) {
//        return ReadOwnerResumeDetailResult.builder()
//                .profileImgUrl(userOwnerJobPostingAggregate.getUser().getProfileImgUrl())
//                .name(userOwnerJobPostingAggregate.getUser().getName())
//                .visa(VisaDto.from(userOwnerJobPostingAggregate.getUser().getVisa()))
//                .personalInformation(PersonalInformationDto.of(userOwnerJobPostingAggregate.getUser()))
//                .introduction(resume.getResume().getIntroduction())
//                .workExperience(!resume.getWorkExperiences().isEmpty() ? resume.getWorkExperiences().stream().map(ReadOwnerResumeDetailResult.WorkExperienceDto::from).toList() : null)
//                .education(!resume.getEducations().isEmpty() ? resume.getEducations().stream().map(
//                        education -> {
...
//                        }
//                ).toList() : null)
//                .languages(LanguagesDto.from(resume))
//                .build();
//    }
        return null;
    }
