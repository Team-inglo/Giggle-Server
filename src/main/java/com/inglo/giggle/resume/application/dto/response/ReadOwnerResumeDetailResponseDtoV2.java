...
@Getter
public class ReadOwnerResumeDetailResponseDtoV2 extends SelfValidating<ReadOwnerResumeDetailResponseDtoV2> {
    ...
    public static ReadOwnerResumeDetailResponseDtoV2 of(Resume resume, List<WorkExperience> workExperiences, List<Education> educations, LanguageSkill languageSkill, User user) {
        return ReadOwnerResumeDetailResponseDtoV2.builder()
                .profileImgUrl(user.getProfileImgUrl())
                .name(user.getName())
                .visa(ReadOwnerResumeDetailResponseDtoV2.VisaDto.fromEntity(user.getVisa()))
                .personalInformation(ReadOwnerResumeDetailResponseDtoV2.PersonalInformationDto.fromEntity(user))
