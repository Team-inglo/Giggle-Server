...
public class ReadUserResumeDetailResponseDtoV2 extends SelfValidating<ReadUserResumeDetailResponseDtoV2> {
    ...
    public static ReadUserResumeDetailResponseDtoV2 of(Resume resume, List<WorkExperience> workExperiences, List<Education> educations, LanguageSkill languageSkill, User user, List<WorkPreference> workPreferences) {
