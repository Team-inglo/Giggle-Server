...
@Getter
public class UpdateSocialIntegrationProgramCommand extends SelfValidating<UpdateSocialIntegrationProgramCommand> {
    ...
    public UpdateSocialIntegrationProgramCommand(
            UUID accountId,
            Integer level
    ) {
