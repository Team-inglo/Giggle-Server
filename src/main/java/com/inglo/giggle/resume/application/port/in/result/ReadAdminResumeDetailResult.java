...
@Getter
public class ReadAdminResumeDetailResult extends SelfValidating<ReadAdminResumeDetailResult> {
    ...
    @Builder
    public ReadAdminResumeDetailResult(
    ...
    public static ReadAdminResumeDetailResult of(
        ...
        return ReadAdminResumeDetailResult.builder()
                .profileImgUrl(resumeDetail.getProfileImgUrl())
                .name(resumeDetail.getName())
                .visa(VisaDto.from(resumeDetail.getVisa()))
                .personalInformation(PersonalInformationDto.of(
                ...
                .education(!resumeDetail.getEducationWithSchoolNames().isEmpty() ? resumeDetail.getEducationWithSchoolNames().stream().map(
                        education -> ReadAdminResumeDetailResult.EducationDto.of(
                                education.getId(),
