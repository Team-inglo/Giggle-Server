...
public class ReadAdminsCareersOverviewsService implements ReadAdminsCareersOverviewsUseCase {
    ...
    public ReadAdminsCareersOverviewsResponseDto execute(
            int page,
            int size,
            String search,
            String sorting,
        ...
        List<ReadAdminsCareersOverviewsResponseDto.CareerOverviewDto> dtos = careerPage.getContent().stream()
                .map(this::toDto)
                .toList();

        return ReadAdminsCareersOverviewsResponseDto.builder()
                .careerList(dtos)
                .hasNext(careerPage.hasNext())
                .build();
    }

    private ReadAdminsCareersOverviewsResponseDto.CareerOverviewDto toDto(Career career) {
        return ReadAdminsCareersOverviewsResponseDto.CareerOverviewDto.builder()
                .id(career.getId())
