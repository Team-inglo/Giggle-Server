package com.inglo.giggle.notification.presentation.dto;
    ...
    public static class NotificationDto extends SelfValidating<NotificationDto> {
        ...
        public static NotificationDto from(Notification notification) {
            return NotificationDto.builder()
                    ...
                    .userOwnerJobPostingId(notification.getUserOwnerJobPostingInfo().getId())
                    .title(notification.getUserOwnerJobPostingInfo().getJobPostingInfo().getTitle())
