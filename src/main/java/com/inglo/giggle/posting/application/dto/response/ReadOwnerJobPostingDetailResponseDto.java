...
@Getter
public class ReadOwnerJobPostingDetailResponseDto extends SelfValidating<ReadOwnerJobPostingDetailResponseDto> {
    ...
    @Builder
    public ReadOwnerJobPostingDetailResponseDto(
    ...
    public static ReadOwnerJobPostingDetailResponseDto of(
        ...
        return ReadOwnerJobPostingDetailResponseDto.builder()
