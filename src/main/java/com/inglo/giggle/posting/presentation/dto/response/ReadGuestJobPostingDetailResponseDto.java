...
public class ReadGuestJobPostingDetailResponseDto extends SelfValidating<ReadGuestJobPostingDetailResponseDto> {
    ...
    public static ReadGuestJobPostingDetailResponseDto of(JobPosting jobPosting, List<CompanyImage> companyImages, List<PostingWorkDayTime> postingWorkDayTimes) {
        return ReadGuestJobPostingDetailResponseDto.builder()
                .id(jobPosting.getId())
                .companyName(jobPosting.getOwnerInfo().getCompanyName())
                .title(jobPosting.getTitle())
                .iconImgUrl(jobPosting.getOwnerInfo().getProfileImgUrl())
                .companyImgUrlList(companyImages.stream().map(
                        CompanyImageDto::from
                ).toList())
                .tags(
                        Tags.from(jobPosting)
                )
                .summaries(
                        Summaries.from(jobPosting)
                )
                .recruitmentConditions(
                        RecruitmentConditions.from(jobPosting)
                )
                .detailedOverview(jobPosting.getDescription())
                .workplaceInformation(
                        WorkplaceInformation.from(jobPosting)
                )
                .workingConditions(
                ...
                .companyInformation(
                        CompanyInformation.from(jobPosting)
                )
    ...
    public static class CompanyImageDto extends SelfValidating<CompanyImageDto> {
        ...
        public static CompanyImageDto from(CompanyImage companyImageEntity) {
            return CompanyImageDto.builder()
                    .id(companyImageEntity.getId())
                    .imgUrl(companyImageEntity.getImgUrl())
                    .build();
        }
    }
    ...
    public static class Tags extends SelfValidating<Tags> {
        ...
        public static Tags from(JobPosting jobPosting) {
            return Tags.builder()
    ...
    public static class Summaries extends SelfValidating<Summaries> {
        ...
        public static Summaries from(JobPosting jobPosting) {
    ...
    public static class RecruitmentConditions extends SelfValidating<RecruitmentConditions> {
        ...
        public static RecruitmentConditions from(JobPosting jobPosting) {
    ...
    public static class WorkplaceInformation extends SelfValidating<WorkplaceInformation> {
        ...
        public static WorkplaceInformation from(JobPosting jobPosting) {
    ...
    public static class WorkingConditions extends SelfValidating<WorkingConditions> {
        ...
        public static WorkingConditions of(JobPosting jobPosting, List<PostingWorkDayTime> postingWorkDayTimes) {
            return WorkingConditions.builder()
                    .hourlyRate(jobPosting.getHourlyRate())
                    .workPeriod(jobPosting.getWorkPeriod())
                    .workDayTime(
                            Optional.ofNullable(postingWorkDayTimes)
                                    .orElse(Collections.emptyList())
                                    .stream()
                                    .map(WorkDayTimeDto::from)
                                    .toList()
                    )
                    .jobCategory(jobPosting.getJobCategory())
        ...
        public static class WorkDayTimeDto extends SelfValidating<WorkDayTimeDto> {
            ...
            public static WorkDayTimeDto from(PostingWorkDayTime postingWorkDayTime) {
    ...
    public static class CompanyInformation extends SelfValidating<CompanyInformation> {
        ...
        public static CompanyInformation from(JobPosting jobPosting) {
            return CompanyInformation.builder()
                    .companyAddress(jobPosting.getOwnerInfo().getAddress().getAddressName())
                    .representativeName(jobPosting.getOwnerInfo().getName())
