...
public class ReadUserUserOwnerJobPostingListResponseDto extends SelfValidating<ReadUserUserOwnerJobPostingListResponseDto> {
    ...
    public static class UserAppliedJobDto extends SelfValidating<UserAppliedJobDto> {
        ...
        public static UserAppliedJobDto from(UserOwnerJobPosting userOwnerJobPosting) {
            ...
            return UserAppliedJobDto.builder()
                    ...
                    .jobPostingId(userOwnerJobPosting.getJobPostingInfo().getId())
                    .iconImgUrl(userOwnerJobPosting.getOwnerInfo().getProfileImgUrl())
                    .companyName(userOwnerJobPosting.getOwnerInfo().getCompanyName())
                    ...
                    .hourlyRate(userOwnerJobPosting.getJobPostingInfo().getHourlyRate())
