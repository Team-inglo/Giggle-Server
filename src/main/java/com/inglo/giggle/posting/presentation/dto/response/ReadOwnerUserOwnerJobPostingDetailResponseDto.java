...
public class ReadOwnerUserOwnerJobPostingDetailResponseDto extends SelfValidating<ReadOwnerUserOwnerJobPostingDetailResponseDto> {
    ...
    public static ReadOwnerUserOwnerJobPostingDetailResponseDto of(
        ...
        return ReadOwnerUserOwnerJobPostingDetailResponseDto.builder()
                .profileImgUrl(userOwnerJobPosting.getUserInfo().getProfileImgUrl())
                .name(userOwnerJobPosting.getUserInfo().getName())
                .nationality(userOwnerJobPosting.getUserInfo().getNationality() != null ? userOwnerJobPosting.getUserInfo().getNationality() : null)
                .gender(userOwnerJobPosting.getUserInfo().getGender().toString())
                .visa(userOwnerJobPosting.getUserInfo().getVisa().toString())
